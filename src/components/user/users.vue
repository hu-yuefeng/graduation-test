...
export default {
  ...
  methods: {
    ...
    getAll(){
      var _this = this;
      this.$http
        .get("http://localhost/yhqx/searchAll",)
    ...
    oneQuest() {
      ...
      this.$http
        .post("http://localhost/yhqx/search", {data})
        .then(function(response) {
          console.log(response.data);
          if (response.data) {
            _this.userlist = response.data;
    ...
    search(user) {
      ...
      this.$http
        .post("http://localhost/yhqx/likeSearch", {data})
        .then(function(response) {
          console.log(response.data);
          if (response.data) {
            _this.userlist=response.data;
    ...
    addUser() {
      ...
      this.$refs.addFormRef.validate(valid => {
        ...
        // 如果预校验成功则发起添加用户请求
        this.$http
        .post("http://localhost/yhqx/add", {data})
        .then(function(response) {
          console.log(response.data);
          if (response.data) {
            _this.$message({
    ...
    editUserInfo() {
      ...
      this.$refs.editFormRef.validate(valid => {
        ...
        // 如果预校验成功则发起修改用户信息的请求
        this.$http
        .post("http://localhost/yhqx/edit", {data})
        .then(function(response) {
          console.log(response.data);
          if (response.data) {
            _this.$message({
    ...
    async removeUserById(id) {
      ...
      this.$http
        .post("http://localhost/yhqx/del", {data})
        .then(function(response) {
          console.log(response.data);
          if (response.data) {
            _this.$message({
