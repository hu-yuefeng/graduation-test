  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="repairsList" stripe border max-height="500px">
        ...
        <el-table-column label="报修人" prop="name" width="60px"></el-table-column>
        <el-table-column label="联系电话" prop="tel" width="100px"></el-table-column>
        <el-table-column label="报修日期" prop="date" width="100px"></el-table-column>
        <el-table-column label="报修时间" prop="time" width="100px"></el-table-column>
        <el-table-column label="报修详情" prop="content"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    oneQuest() {
      ...
      var _this = this;
      this.$http
        .post("http://localhost/shbx/search", {data})
        .then(function(response) {
          console.log(response.data);
          if (response.data) {
            _this.repairsList = response.data;
          }
        });
    },
    getAll(){
      var _this = this;
      this.$http
        .get("http://localhost/shbx/searchAll")
        .then(function(response) {
          console.log(response.data);
          if (response.data) {
